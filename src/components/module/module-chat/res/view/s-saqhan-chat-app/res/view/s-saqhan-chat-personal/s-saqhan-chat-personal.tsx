    ...
    return (
      <div class="personal-messages">
        ...
        <div class="messages-block">
          ...
          <div class="admin-mess">
            <div class="mess-admin">
              ...
              <span class="admin-text">
                Так давайте снимим карантин, пусть все выйдут на работу!
              </span>
              <span class="mess-date">30.08.2020 09:20</span>
            </div>
          </div>
          <div class="personal-mess">
            <div class="mess-user">
              <span class="user-text">Мировой заговр, все об этом знают!</span>
              <span class="mess-date">30.08.2020 09:20</span>
            </div>
          </div>
          <div class="admin-mess">
            <div class="mess-admin">
              ...
              <span class="admin-text">
                Мы с Вами согласны и сейчас перевели миллион на лечение.
              </span>
              <span class="mess-date">30.08.2020 09:20</span>
            </div>
          </div>
          ...
          <div class="personal-mess">
            <div class="mess-user">
              <span class="user-text">
                Hello there! pls tell me, where a u?
              </span>
              <span class="mess-date">30.08.2020 09:20</span>
            </div>
          </div>
          <div class="admin-mess">
            <div class="mess-admin">
              ...
              <span class="admin-text">
                Спасибо! мы обязательно свяжемся и переведем сумму денег (нет)
              </span>
              <span class="mess-date">30.08.2020 09:20</span>
            </div>
          </div>
